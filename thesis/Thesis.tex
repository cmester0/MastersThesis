...
\todo[inline]{algebra for functor ? \texttt{W}-types? should there be a decription of these?}
...
\todo{...} again we run into problems with the axiom of choice. The construction of Q\texttt{W}-types got around this problem, by doing the construction as a QIIT, we will try and follow the same ideas and show what that would look like for \texttt{M}-types. \todo{Complete construction of Q\texttt{W} inspired Q\texttt{M}-types}
