...
\end{itemize}
That this translation exists enforces the idea that QIITs have the right semantic, while behaving better than the Q\texttt{M}-types. We followed this construction in \subsectionref{multiset} on multisets, however in \subsectionref{partiality-monad} on the partiality monad, we constructed a more advanced QIIT. Lets look at why we did this, by constructing the partiality monad again, but with this simple method instead.
\begin{exmp}
  ...
  \end{equation}
  Constructing a function from the Q\texttt{M}-type to this QIIT and showing it is injective is easy, however showing surjectivity is harder.
\end{exmp}
