...
\subsection{Interactive Proof Assistants}
...
\subsubsection{Martin L\"of Type Theory / Intuitionistic type Theory (MLTT/ITT)}
...
\paragraph{Intensional Type Theory}
...
\subsection{Homotopy Type Theory (HoTT) / Univalent Foundations (UF)}
...
\subsubsection{Judgmental Equality / Definitional Equality}
...
\subsubsection{The HoTT Book}

\subsection{Higher order inductive types (HITs)}
\subsubsection{Propositional truncation and Set Truncated Quotients}

\subsection{Cubical Type Theory (CTT)}
