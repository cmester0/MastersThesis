...
\newcommand*{\containerpairsimple}[2]{\textcolor{red}{(}#1\,\textcolor{red}{,}\,\lambda\,\_, #2\textcolor{red}{)}}
...
In this section we show some examples of types that can be constructed as \(M\)-types, and show how their constructors can be defined. \todo{Is there anything else that is show for each M-type?}
