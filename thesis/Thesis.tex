...
\vspace*{\fill}\noindent{\rule{\linewidth}{1mm}\\[4ex]
  {\Huge\sf \texttt{M}-types and Co-induction in HoTT and Cubical Type Theory}\\[2ex]
...
We start by defining a equation system called a covariety \cite{Hughes}\cite{Covariety} of a coalgebra (dual of variety of an algebra).
\\ \\
